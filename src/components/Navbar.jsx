        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3 shrink-0 ml-4">
            ...
            <button
              ...
              className="p-2 rounded-lg border border-white/15 bg-[#2b2829] text-[#e7d49d] hover:bg-white/10 hover:border-[#e7d49d]/50 transition-all cursor-pointer min-h-[38px] min-w-[38px] flex items-center justify-center"
            >
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 text-xs px-3 py-2 rounded-lg border border-white/15 bg-[#2b2829] text-white/90 hover:border-[#e7d49d]/50 hover:text-[#e7d49d] transition-colors cursor-pointer min-h-[38px]"
              >
            ...
            <button
              ...
              className="gold-btn font-bold text-xs uppercase tracking-wider px-4 py-2.5 rounded-lg shadow-md hover:scale-105 active:scale-95 transition-all flex items-center gap-2 whitespace-nowrap cursor-pointer min-h-[38px]"
            >
            ...
            <button
              ...
              className="p-2 rounded-lg focus:outline-none border border-white/15 bg-[#2b2829] text-white hover:bg-white/10 2xl:hidden cursor-pointer min-h-[38px] min-w-[38px] flex items-center justify-center"
          ...
          <div className="flex lg:hidden items-center gap-2 shrink-0">
            <button
              onClick={() => setTheme(isDark ? 'light' : 'dark')}
              className="p-2.5 rounded-xl border border-white/15 bg-[#2b2829] text-[#e7d49d] hover:bg-white/10 transition-all cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center"
              title={isDark ? "Mudar para Modo Claro" : "Mudar para Modo Escuro"}
            >
              {isDark ? <Sun className="w-4.5 h-4.5" /> : <Moon className="w-4.5 h-4.5 text-[#e7d49d]" />}
            </button>

            <button
              onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
              className="p-2.5 rounded-xl focus:outline-none border border-white/15 bg-[#2b2829] text-white hover:bg-white/10 cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center"
              aria-label="Abrir Menu de Navegação"
            >
              {mobileMenuOpen ? <X className="w-5 h-5" /> : <Menu className="w-5 h-5" />}
            </button>
