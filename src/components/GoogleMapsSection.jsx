...
export default function GoogleMapsSection({ theme }) {
  ...
  return (
    <section id="localizacao" className={`py-12 lg:py-24 transition-colors duration-400 border-t ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
          ...
          {/* Left Info Card */}
          <div className={`lg:col-span-4 p-6 sm:p-8 rounded-2xl border flex flex-col justify-between space-y-6 shadow-xl ${
            isDark 
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className={`text-xs font-light mt-1.5 leading-relaxed ${isDark ? 'text-stone-300' : 'text-stone-600'}`}>
              ...
              <div className="space-y-3 pt-4 border-t border-stone-500/20 text-xs">
                ...
                >
                  ...
                  <span className="truncate">{QUINTA_INFO.contactos.email}</span>
                </a>
