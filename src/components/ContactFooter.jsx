...
export default function ContactFooter({ theme, currentLang }) {
  ...
  return (
    <footer id="contactos" className={`transition-colors duration-400 border-t pt-16 pb-12 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="flex items-center gap-3">
              ...
              />
              <span className={`font-serif-luxury text-2xl font-bold tracking-wider uppercase ${
          ...
          <div className={`lg:col-span-7 p-6 sm:p-8 rounded-2xl border shadow-xl ${
            isDark ? 'bg-[#353233] border-white/10 text-white' : 'bg-white border-stone-200 text-[#1a1919]'
          }`}>
            <h3 className="font-serif-luxury text-2xl font-bold mb-2">
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full gold-btn font-bold text-xs uppercase tracking-widest py-3.5 rounded-lg shadow-lg flex items-center justify-center gap-2"
                >
        ...
        <div className="pt-8 border-t border-stone-500/20 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-stone-400">
          ...
          <div className="flex items-center gap-4 shrink-0">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border border-stone-500/30 hover:border-[#ac926f] bg-white/5 hover:bg-white/10 transition-all group"
